...
gridfactor = 0.01 #nm
maxgridpoints = 20000000 #for controlling the size
...
material =[[ 1000.0, 'GaN', 0.0, 1e17, 'n', 'b'],
            [ 400.0, 'GaN', 0.0, 5e18, 'n', 'w'],
            [ 10.0, 'AlGaN', 0, 5e18, 'n', 'b'],
	    [ 10.0, 'AlGaN', 0.52, 3e19, 'n','w'],
	    [ 1.5, 'AlN', 0, 0, 'n', 'b'],
	    [ 1.0, 'GaN', 0, 0, 'n', 'w'],
	    [ 1.75, 'AlGaN', 0.85, 7e13, 'n', 'b'],
	    [ 1.5, 'AlN', 0, 0, 'n', 'w'],
 	     [ 1.5, 'AlN', 0, 0, 'n', 'b'],
	    [ 1.0, 'GaN', 0, 0, 'n', 'w'],
	    [ 1.75, 'AlGaN', 0.85, 7e13, 'n', 'b'],
	    ...
	    [ 400.0, 'GaN', 0.0, 5e18, 'n', 'b'],
	    [ 1000.0, 'GaN', 0.0, 1e17, 'n', 'w']]
